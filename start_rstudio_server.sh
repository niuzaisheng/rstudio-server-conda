...
COOKIE_KEY_PATH=/home/${USER}/rstudio-server/${USER}_secure-cookie-key
...
then
  REVOCATION_LIST_DIR=/home/${USER}/rstudio-server/${USER}_revocation-list-dir
...
CONDA_ENV_PATH=/home/${USER}/rstudio-server/${USER}_current_env
rm -f $CONDA_ENV_PATH
echo "## Current env is >>"
echo $CONDA_PREFIX
